...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZ2dwZXRlcmdnIiwiYSI6ImNsYWFyOXRldDBhNnEzcW12YXluMDZvZG8ifQ.HuYMXEYq3QoaFztHU3b-MA';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            stripe = Stripe("pk_test_51M6AhPD89qrOoyFfAEQJ3kasSmoHTjeUy911aqcc4mLVVgi6Fo3qaSBjZlnWDIjJOXCznIWsDVnuPj77YXosYmYE00IvDIJPE6");
            _context.next = 4;
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
// we now have an entry file to interact with the front end and delegate actions to functions coming from this file.
// we can also export data from this module..
// node js uses common js but in front end we use modules. the syntax is a bit different but similar

// there's also something similar to module.exports, which is the default export..
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var tourId = e.target.dataset.tourId; //use destructuring bc it has same name as html class
